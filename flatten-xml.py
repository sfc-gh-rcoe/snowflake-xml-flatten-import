...
def main(stage_name = sys.argv[1], input_file_name = sys.argv[2], output_table_name = sys.argv[3]): 
    ...
    the_select_string = "SELECT {} FROM {}".format("CATALOG_BOOK['@id'] as BOOK_ID, CATALOG_BOOK:author as AUTHOR, CATALOG_BOOK:title as TITLE, CATALOG_BOOK:genre as GENRE", output_table_name)
